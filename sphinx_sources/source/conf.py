...
project = u'Python Resources'
copyright = u'2014, Christopher Barker, Cris Ewing, Maria McKinley'
...
htmlhelp_basename = 'PythonResourcesDoc'
...
latex_documents = [
  ('index', 'PythonResources.tex', u'Python Resources for UWPCE Certificate program',
...
man_pages = [
    ('index', 'Python Resources', u'Python Resources for UWPCE Certificate Program',
...
slide_theme_options = {
    'subtitle': 'Resources for the UWPCE Certificate Program',
